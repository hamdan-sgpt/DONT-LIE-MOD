@echo off
title Minecraft Client 4 - Player4
echo ==========================================
echo   MINECRAFT CLIENT 4 - Player4
echo ==========================================
echo.
...
if not exist "run-client4\saves\MAP-DONT-LIE" (
    echo [INFO] Memasang World Map 'MAP-DONT-LIE' ke run-client4/saves...
    xcopy /E /I /Y /Q "MAP-DONT-LIE" "run-client4\saves\MAP-DONT-LIE" >nul
)
if not exist "run-client4\MAP-DONT-LIE" (
    echo [INFO] Memasang World Map source ke run-client4/MAP-DONT-LIE...
    xcopy /E /I /Y /Q "MAP-DONT-LIE" "run-client4\MAP-DONT-LIE" >nul
)
...
echo Menjalankan Minecraft sebagai "Player4"...
echo.
call gradlew.bat runClient4 --args="--username Player4"
pause
